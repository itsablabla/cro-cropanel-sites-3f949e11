...
Site: example.com · Priority 8 · High · Effort: Medium (2-5 days)

## Problem
The homepage shows no sign of returns policy, guarantee, reviews, security badge, so a first-time visitor has nothing to offset purchase risk.
